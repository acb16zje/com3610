...
reports the issues found in each revision.
...
As mentioned in \hyperref[sec:challenges]{\textbf{Section \ref*{sec:challenges}}}, the main challenges of this project
...
(\hyperref[sec:realworld]{\textbf{Section \ref*{sec:realworld}}}) might have lower quality compared to a
...
\subsection{Commit Messages Searching}
\begin{figure}[H]
  \centering
  \includegraphics[width=.85\linewidth]{images/keyword_search.png}
  \caption{An example of expected search behaviour for the query \textbf{`CVE'}}
...
% https://github.com/apache/camel/commit/b9a3117f19dd19abd2ea8b789c42c3e86fe4c488
% Too many files changed will cause the program to hang, so skip the commit

\chapter{Results and Discussion}
\section{Case Study}
% CVE-2019-0211
% https://github.com/apache/httpd/commit/a41bac19547489f399015064ffdf52545c5c3a87
