...
\begin{figure}[H]
  ...
  \begin{tikzpicture}
    ...
    \draw [arrow] (file_supported) -| node [very near start, anchor=south] {no} (-5.5, -7.5) ++ (0,
    0) -- (has_next_commit);
...
The general flow of the repository mining tool is shown in
\hyperref[figure:activity_diagram]{\textbf{Figure \ref*{figure:activity_diagram}}}. Details
...
\section{Flawfinder and Bandit Integration}
