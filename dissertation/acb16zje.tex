...
\begin{ganttchart}[
	...
	\gantttitle{Semester 1 and Christmas Vacation}{6} \\
	\gantttitlelist{11,...,16}{1} \\
  \ganttbar{Design}{1}{1} \\
  \ganttbar{Early implementation and testing}{2}{6}
\end{ganttchart}
...
\gantttitle{Iteration 1}{4} \\
\gantttitlelist{1,...,4}{1} \\
\ganttbar{Implement prototype}{1}{2} \\
\ganttbar{Testing prototype}{3}{4}
\end{ganttchart}
...
\gantttitle{Iteration 2}{5} \\
\gantttitlelist{4,...,8}{1} \\
\ganttbar{Prototype fixes}{1}{1} \\
\ganttbar{Develop prototype to software}{2}{3} \\
\ganttbar{Testing software}{3}{5}
\end{ganttchart}
...
\ganttbar{Iteration 1}{1}{4} \\
\ganttbar{Iteration 2}{5}{8} \\
\ganttbar{Writing dissertation}{8}{10} \\
