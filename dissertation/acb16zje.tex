...
\begin{ganttchart}[
	...
	\ganttbar{Requirements}{6}{7} \\
	\ganttbar{Further Analysis}{7}{8} \\
	\ganttbar{Proof reading and amendment}{9}{10}
\end{ganttchart}
...
\gantttitlelist{1,...,12}{1} \\
\ganttbar{Design}{1}{2} \\
\ganttbar{Implement prototype}{3}{5} \\
\ganttbar{Testing prototype}{5}{6} \\
